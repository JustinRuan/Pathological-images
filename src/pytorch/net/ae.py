...
class Autoencoder2(nn.Module):
    def __init__(self, out_dim):
        ...
        self.decoder =  nn.Sequential(
            OrderedDict([
                ("deconv1", nn.ConvTranspose2d(128, 128, kernel_size=2, stride=2, padding=0)),
                ("relu1",   nn.ReLU()),
                ("bn_c1",   nn.BatchNorm2d(128, affine=False)),
                ("deconv2", nn.ConvTranspose2d(128, 64, kernel_size=3, stride=1, padding=1)),
                ("relu2",   nn.ReLU()),
                ("deconv3", nn.ConvTranspose2d(64, 64, kernel_size=2, stride=2, padding=0)),
                ("relu3",   nn.ReLU()),
                ("bn_c3",   nn.BatchNorm2d(64, affine=False)),
                ("deconv4", nn.ConvTranspose2d(64, 32, kernel_size=3, stride=1, padding=1)),
                ("relu4",   nn.ReLU()),
                ("deconv5", nn.ConvTranspose2d(32, 32, kernel_size=2, stride=2, padding=0)),
                ("relu5",   nn.ReLU()),
                ("bn_c5",   nn.BatchNorm2d(32, affine=False)),
                ("deconv6", nn.ConvTranspose2d(32, 3, kernel_size=3, stride=1, padding=1)),
                ("sigmoid", nn.Sigmoid()),
            ])
        )
        # self.fc3 = nn.Linear(out_dim, intermediate_size)
