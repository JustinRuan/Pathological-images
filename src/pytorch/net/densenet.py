...
class DMC_DenseNet(ExtendedDenseNet):
    ...
    #     features20 = self.features(x20)
    #     pool_feature20 = self.pool_final(features20)
    #     self.out_feature20 = pool_feature20.view(pool_feature20.size(0), -1)
    #     out20 = self.classifier(self.out_feature20)
    #
    #     # features40 = self.features(x40)
    #     # pool_feature40 = self.pool_final(features40)
    #     # self.out_feature40 = pool_feature40.view(pool_feature40.size(0), -1)
    #     # out40 = self.classifier(self.out_feature40)
    #     #
    #     # self.out_feature = torch.cat([self.out_feature20, self.out_feature40], 1)
