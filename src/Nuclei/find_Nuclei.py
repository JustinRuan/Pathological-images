...
from Nuclei import anisodiff2D, FastRadialSymmetryTransform, post_process, colorNormalization


def read_image(filename):
    # img = io.imread('F:/3950.tif')
...
def main():
    ...
    fig, axes = plt.subplots(2, 3, figsize=(40, 30), dpi=60)
    ax = axes.ravel()
