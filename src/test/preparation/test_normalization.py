...
class TestNormalization(unittest.TestCase):
    ...
    def test_calc_hist(self):
        ...
        # normal.calculate_hist("Target", "Target_T1_4000_256_test.txt", file_code = "hist_templates_T1")
        normal.calculate_hist("P0404", "T_NC_Simple0404_4000_256_test.txt",file_code = "hist_source_P0404")
