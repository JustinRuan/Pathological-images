...
class Test_detector(unittest.TestCase):
    ...
    #     id = "003"
    #     # 读取数字全扫描切片图像
    #     tag = imgCone.open_slide("D:/code/dataset/camelyon16/Tumor_%s.tif" % id,
    ...
    def test_detect2(self):
        ...
        np.savez("{}/data/cancer_predictions_{}".format(c.PROJECT_ROOT, id), src_img, seeds, predictions,
                 new20_seeds, new20_predictions, new40_seeds, new40_predictions
                 )
