...
class TestCancerMapBuilder(unittest.TestCase):
    ...
    def test_train(self):
        ...
        sc = SlideClassifier(c, "Slide_simple", "32")
        filename = "slide_train_data32_p0.6_np1.0.npz"
        sc.train(filename, class_weight=None, batch_size=1000, loss_weight=0.01,epochs=100)
